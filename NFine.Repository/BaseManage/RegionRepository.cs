...
{
    public class RegionRepository : RepositoryBase<RegionEntity>, IRegionRepository
    {
        public List<RegionEntity> FindList(Expression<Func<RegionEntity, bool>> predicate)
        {
        ...
        public List<RegionEntity> FindList(Expression<Func<RegionEntity, bool>> predicate, Pagination pagination, string keyword)
        {
            var expression = ExtLinq.True<RegionEntity>();
            expression.And(predicate);
