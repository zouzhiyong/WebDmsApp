...
{
    public class MaterialGroupRepository : RepositoryBase<MaterialGroupEntity>, IMaterialGroupRepository
    {
        public List<MaterialGroupEntity> FindList(Expression<Func<MaterialGroupEntity, bool>> predicate)
        {
        ...
        public List<MaterialGroupEntity> FindList(Expression<Func<MaterialGroupEntity, bool>> predicate, Pagination pagination, string keyword)
        {
            var expression = ExtLinq.True<MaterialGroupEntity>();
            expression.And(predicate);
