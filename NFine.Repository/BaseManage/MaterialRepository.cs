...
namespace NFine.Repository.BaseManage
{
    public class MaterialRepository : RepositoryBase<MaterialEntity>, IMaterialRepository
    {
        ...
        public List<MaterialEntity> FindList(Expression<Func<MaterialEntity, bool>> predicate)
        {
        ...
        public List<MaterialEntity> FindList(Expression<Func<MaterialEntity, bool>> predicate, Pagination pagination, string keyword)
        {
            var expression = ExtLinq.True<MaterialEntity>();
            expression.And(predicate);
