...
namespace NFine.Repository.BaseManage
{
    ...
    {
        public List<SupplierEntity> FindList(Expression<Func<SupplierEntity, bool>> predicate)
        {
        ...
        public List<SupplierEntity> FindList(Expression<Func<SupplierEntity, bool>> predicate, Pagination pagination, string keyword)
        {
            var expression = ExtLinq.True<SupplierEntity>();
            expression.And(predicate);
