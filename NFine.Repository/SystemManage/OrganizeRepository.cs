...
namespace NFine.Repository.SystemManage
{
    ...
    {
        public List<OrganizeEntity> FindList(Expression<Func<OrganizeEntity, bool>> predicate)
        {
        ...
        public List<OrganizeEntity> FindList(Expression<Func<OrganizeEntity, bool>> predicate, Pagination pagination, string keyword)
        {
            var expression = ExtLinq.True<OrganizeEntity>();
            expression.And(predicate);
