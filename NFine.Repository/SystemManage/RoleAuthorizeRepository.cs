...
namespace NFine.Repository.SystemManage
{
    ...
    {
        public List<RoleAuthorizeEntity> FindList(Expression<Func<RoleAuthorizeEntity, bool>> predicate)
        {
        ...
        public List<RoleAuthorizeEntity> FindList(Expression<Func<RoleAuthorizeEntity, bool>> predicate, Pagination pagination, string keyword)
        {
            var expression = ExtLinq.True<RoleAuthorizeEntity>();
            expression.And(predicate);
