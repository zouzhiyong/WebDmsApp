...
namespace NFine.Repository.SystemManage
{
    ...
    {
        public List<DepartmentEntity> FindList(Expression<Func<DepartmentEntity, bool>> predicate)
        {
        ...
        public List<DepartmentEntity> FindList(Expression<Func<DepartmentEntity, bool>> predicate, Pagination pagination, string keyword)
        {
            var expression = ExtLinq.True<DepartmentEntity>();
            expression.And(predicate);
